...
class FileProcessor:
    ...
    def read_data_from_file(file_name: str):
        ...
        try:
            ...
            print()
            print('The file was not found. Please check that the file is in the same folder as this script.\n' +
                  'To create a new file, select option 2 to add data. Error text: ')
            print(e, e.__doc__, type(e), sep='\n')
        except Exception as e:
            print('There was a general error!')
            print(e, e.__doc__, type(e), sep='\n')
